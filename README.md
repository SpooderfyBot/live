# MODIFIED VERSION OF [LIVE GO](https://github.com/SpooderfyBot/live), I HIGHLY ADVISE YOU USE THEIR BRANCHES RATHER THAN THIS.
...
[![Test](https://github.com/SpooderfyBot/live/workflows/Test/badge.svg)](https://github.com/SpooderfyBot/live/actions?query=workflow%3ATest)
[![Release](https://github.com/SpooderfyBot/live/workflows/Release/badge.svg)](https://github.com/SpooderfyBot/live/actions?query=workflow%3ARelease)
...
## Installation
After directly downloading the compiled [binary file](https://github.com/SpooderfyBot/live/releases), execute it on the command line.

#### Boot from Docker
Run `docker run -p 1935:1935 -p 7001:7001 -p 7002:7002 -p 8090:8090 -d chillfish8/live` to start

#### Compile from source
1. Download the source code `git clone https://github.com/SpooderfyBot/live.git`
